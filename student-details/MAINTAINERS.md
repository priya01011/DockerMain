# Maintaining the docker/student-details Image

This document is for maintainers of this repository.

## Docker Hub Image

The image is stored on Docker Hub in the [`docker/student-details`](https://hub.docker.com/r/docker/student-details) repository.
...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag docker/student-details .
```
...
```bash
docker run --pull always -p 8088:80 docker/student-details:latest
```
